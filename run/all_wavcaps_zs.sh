...
python zeroshot.py config/wavcaps.yaml as batch_size=64,name=$NAME,weight_file=external/WavCaps/HTSAT_BERT_zero_shot.pt
python zeroshot.py config/wavcaps.yaml fsd50k batch_size=64,name=$NAME,weight_file=external/WavCaps/HTSAT_BERT_zero_shot.pt
